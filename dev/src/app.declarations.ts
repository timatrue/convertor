...
import {ColorConvertors} from "./color-convertors/color-convertors";

/**
 * Created by artem on 23/05/2017.
 */
export const DECLARATIONS: any[] = [AppComponent, ColorConvertors, ConvertorList, HexRgbBox, BinDecBox, HexRgbExt, MemoryHexRgb, DynamicBackground];